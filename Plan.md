...
6. clear image prior: L1/L2, refer to (code available): refer to ["Blind Deconvolution Using a Normalized Sparsity Measure"](https://dilipkay.files.wordpress.com/2019/04/priors_cvpr11.pdf)
